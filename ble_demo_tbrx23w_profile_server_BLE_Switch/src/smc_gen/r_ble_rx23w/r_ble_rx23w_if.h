...
/***********************************************************************************************************************
* File Name    : r_ble_rx23w_if.h
* Description  : Functions for using BLE module on RX23W devices.
***********************************************************************************************************************/
/***********************************************************************************************************************
 ...
 * @brief R_BLE GATT Server API
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @defgroup gatt_client_api GATT Client API
 * @brief R_BLE GATT Client API
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @defgroup l2cap_api L2CAP API
 * @brief R_BLE L2CAP API
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @defgroup vs_api Vendor Specific API
 * @brief R_BLE Vendor Specific API
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @defgroup main_api Common API
 * @brief R_BLE Common API
***********************************************************************************************************************/

#ifndef R_BLE_RX23W_IF_H
#define R_BLE_RX23W_IF_H
 ...
 * @brief   ble_status_t is the type that indicates @ref e_r_ble_err_code_t "the API result" or @ref e_r_ble_err_code_t "the BLE status" . 
 **********************************************************************************************************************/
typedef uint16_t ble_status_t;

/* error code */
/******************************************************************************************************************//**
 * @typedef e_r_ble_err_code_t
 * @brief   BLE error code ID.
 **********************************************************************************************************************/
...
typedef struct 
{
     ...
     *   the BLE_CFG_RF_ADV_SET_MAX number of the advertising sets may not exceed 
     *   the buffer size(4250 bytes) in Controller. \n
     *   \n
     *   In case of periodic advertising data, the length is 0 - 1650 bytes.\n
     *   Note that the length of the periodic advertising data in the BLE_CFG_RF_ADV_SET_MAX number of 
...
typedef struct
{
     ...
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_SECURITY_ENC 0x00000010</td>
     *                      <td>Encryption<BR/>
     ...
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_7 0x01000000</td>
     *                      <td>7-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_8 0x02000000</td>
     *                      <td>8-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_9 0x03000000</td>
     *                      <td>9-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_10 0x04000000</td>
     *                      <td>10-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_11 0x05000000</td>
     *                      <td>11-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_12 0x06000000</td>
     *                      <td>12-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_13 0x07000000</td>
     *                      <td>13-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_14 0x08000000</td>
     *                      <td>14-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_15 0x09000000</td>
     *                      <td>15-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENCRYPT_KEY_SIZE_16 0x0A000000</td>
     *                      <td>16-byte encryption key.</td>
     *                  </tr>
     *                  <tr>
     *                      <td>#define BLE_GATT_DB_SER_ENC_KEY_SIZE_DONT_CARE 0x00000000</td>
 ...
 * @return none
 **********************************************************************************************************************/
typedef void ( *  ble_gatts_app_cb_t)
                   (
                       uint16_t event_type,
                       ble_status_t event_result,
 ...
 * @return none
 **********************************************************************************************************************/
typedef void ( * ble_gattc_app_cb_t)
                   (
                       uint16_t event_type,
                       ble_status_t event_result,
 ...
 * @return none
 **********************************************************************************************************************/
typedef void ( * ble_l2cap_cf_app_cb_t)
                   (
                       uint16_t event_type,
                       ble_status_t event_result,
...
/******************************************************************************************************************//**
 * @fn void R_BLE_LPC_Init(void)
 * @brief   Initialize Low Power Control Function.
 * @details This function initializes the Low Power Control Function in MCU.
 * @param   void
 * @retval  void
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 * @fn void R_BLE_LPC_EnterLowPowerMode(void)
 * @brief   Enter Low Power Mode.
 * @details MCU enters the Low Power Mode by this function.
 * @param   void
 * @retval  void
 **********************************************************************************************************************/
...
/******************************************************************************************************************//**
 * @fn void R_BLE_LPC_SetInhibitSoftwareStandby(bool inhibit)
 * @brief   Set inhibit state of MCU software standby mode.
 * @details Call this function to set the inhibit state.
 * @param[in] inhibit 
 *               |    macro    |           description            |
 *               |:------------|:-------------------------------- |
 *               | false(0x00) | MCU enter software standby.      |
 *               | true(0x01)  | MCU not enter software standby.  |
 * @retval  void
 **********************************************************************************************************************/
void R_BLE_LPC_SetInhibitSoftwareStandby(bool inhibit);

/******************************************************************************************************************//**
 * @fn bool R_BLE_LPC_GetInhibitSoftwareStandby(void)
 * @brief   Get inhibit state of MCU software standby mode.
 * @details Call this function to get the inhibit state.
 * @param   void
 * @retval  false(0x00) MCU enter software standby mode.
 * @retval  true(0x01)  MCU not enter software standby mode.
 **********************************************************************************************************************/
 ...
 *          The number of advertising set in the Controller is defined as BLE_CFG_RF_ADV_SET_MAX.
 ...
 *           In this case, @ref BLE_VS_EVENT_TX_TEST_START event returns @ref BLE_ERR_INVALID_ARG(0x0003) .
 * 
 ...
 *          - Low
 *           
 *          The transmit power levels are dependent on the configuration of the firmware. \n
 *          When @ref BLE_CFG_RF_MAX_TX_POW = 0(0dBm), \n
 * 
 *            High    :   0dBm \n
 *            Middle  :   0dBm \n
 *            Low     : -18dBm
 *
 *          When @ref BLE_CFG_RF_MAX_TX_POW = 1(+4dBm),  \n
 * 
 *            High    :  +4dBm \n
 *            Middle  :   0dBm \n
 *            Low     : -20dBm
...
#define BT_PACK_BE_4_BYTE_VAL(dst, src) \
    ...
    *((uint8_t *)(dst) + 2) = (uint8_t)((src) >> 8);\
    *((uint8_t *)(dst) + 1) = (uint8_t)((src) >> 16);\
    *((uint8_t *)(dst) + 0) = (uint8_t)((src) >> 24);
...
#if defined(__ICCRX__) && !defined(DISBALE_BLE_SECTION) 

#define __R_BLE_ATTRIB_SECTION_CHANGE_V(section_name)          R_BSP_PRAGMA(location=#section_name)\
                                                               __no_init
                                                               
#define __R_BLE_ATTRIB_SECTION_CHANGE_F(section_name)          R_BSP_PRAGMA(location=#section_name)

#define _R_BLE_ATTRIB_SECTION_CHANGE_B1(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_V(section_tag##_1)
#define _R_BLE_ATTRIB_SECTION_CHANGE_B2(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_V(section_tag##_2)
#define _R_BLE_ATTRIB_SECTION_CHANGE_B4(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_V(section_tag)
#define _R_BLE_ATTRIB_SECTION_CHANGE_B8(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_V(section_tag##_8)
#define _R_BLE_ATTRIB_SECTION_CHANGE_C1(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_1)
#define _R_BLE_ATTRIB_SECTION_CHANGE_C2(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_2)
#define _R_BLE_ATTRIB_SECTION_CHANGE_C4(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag)
#define _R_BLE_ATTRIB_SECTION_CHANGE_C8(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_8)
#define _R_BLE_ATTRIB_SECTION_CHANGE_D1(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_1)
#define _R_BLE_ATTRIB_SECTION_CHANGE_D2(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_2)
#define _R_BLE_ATTRIB_SECTION_CHANGE_D4(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag)
#define _R_BLE_ATTRIB_SECTION_CHANGE_D8(section_tag)           __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag##_8)
#define _R_BLE_ATTRIB_SECTION_CHANGE_P(section_tag)            __R_BLE_ATTRIB_SECTION_CHANGE_F(section_tag)

#define R_BLE_ATTRIB_SECTION_CHANGE(type, sec_tag, ...)        _R_BLE_ATTRIB_SECTION_CHANGE_##type##__VA_ARGS__(sec_tag)
#define R_BLE_ATTRIB_SECTION_CHANGE_END                        /* none */
...
#define BLE_PRAGMA_INTERRUPT(function_name, vector)            R_BSP_PRAGMA_INTERRUPT(function_name, vector)
#define BLE_PRAGMA_STATIC_INTERRUPT(function_name, vector)     R_BSP_PRAGMA_STATIC_INTERRUPT(function_name, vector)
#define BLE_PRAGMA_INTERRUPT_FUNCTION(function_name)           R_BSP_PRAGMA_INTERRUPT_FUNCTION(function_name)
#define BLE_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name)    R_BSP_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name)
#define BLE_ATTRIB_INTERRUPT                                   R_BSP_ATTRIB_INTERRUPT
#define BLE_ATTRIB_STATIC_INTERRUPT                            R_BSP_ATTRIB_STATIC_INTERRUPT
#else /* defined(__CCRX__) || defined(__ICCRX__) */
#define BLE_NOP()
#define BLE_PRAGMA_INTERRUPT(function_name, vector)
#define BLE_PRAGMA_STATIC_INTERRUPT(function_name, vector)
#define BLE_PRAGMA_INTERRUPT_FUNCTION(function_name)  
#define BLE_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name)
#define BLE_ATTRIB_INTERRUPT
#define BLE_ATTRIB_STATIC_INTERRUPT
#endif /* defined(__CCRX__) || defined(__ICCRX__) */

#define BLE_SECTION_B(x) BLE_SECTION_CHANGE(B, BLE_B, x)
#define BLE_SECTION_C(x) BLE_SECTION_CHANGE(C, BLE_C, x)
#define BLE_SECTION_D(x) BLE_SECTION_CHANGE(D, BLE_D, x)
#define BLE_SECTION_P    BLE_SECTION_CHANGE_P(P, BLE_P)

#ifdef __cplusplus
};
#endif

#endif /* R_BLE_RX23W_IF_H */
