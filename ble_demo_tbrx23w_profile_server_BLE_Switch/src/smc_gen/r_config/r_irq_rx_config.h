...
#define IRQ_CFG_FILT_EN_IRQ5       (1)   /* Filtering disabled on IRQ 5. */
...
#define IRQ_CFG_FILT_PLCK_IRQ0    (IRQ_CFG_PCLK_DIV1)  /* Filter sample clock divisor for IRQ 0 = PCLK/64. */
#define IRQ_CFG_FILT_PLCK_IRQ1    (IRQ_CFG_PCLK_DIV1)  /* Filter sample clock divisor for IRQ 1 = PCLK/64. */
...
#define IRQ_CFG_FILT_PLCK_IRQ5    (IRQ_CFG_PCLK_DIV64)   /* Filter sample clock divisor for IRQ 5 = PCLK. */
